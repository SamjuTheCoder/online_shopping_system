...
@section('content')
 ...
 <table class="table ">
		  ...
		  <tr>
            <th class="t-head head-it" style="width:100px !important">Action</th>
		  ...
		  <tr>
			...
			<td class="t-data" data-th="Quantity">
                ...
                <input type="number" value="{{ $details['qty'] }}" data-id="{{ $id }}" class="form-control quantity update-cart" style="width:60px !important"/>
          ...
          <tr class="">
			...
			<td class="t-data"> <strong>Total: &#x20A6;{{ number_format($total)}}</strong></td>
			<td class="t-data"> 
                @if(Auth::user())
		            <a class="pull-left btn btn-info" href="{{ route('checkOut') }}">Check Out <i class="fa fa-angle-right"></i></a>
                @else
                    <a class="pull-left btn btn-info" href="{{ url('/login') }}">Check Out <i class="fa fa-angle-right"></i> </a>
                @endif
			</td>
		  </tr>
	</table>
